...
Motivation: specific sampling from a grid, random small square inside a bunch of 10 small squares, for each bunch of 10 small squares
...
for (l in 0:((1000/c_dim)-1)) { # For all lines
  for (bunch in 1:(1000/(c_dim*10))) { # 10 is the size of each bunch
    x_sampled <- sample(0:9, 1)*c_dim + (bunch-1)*10*c_dim
    a <- runif(1, x_sampled, x_sampled + c_dim)
