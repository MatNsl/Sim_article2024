...
MC_boot <- function(n, B1, B2, f1, f2){
  ...
  for (b in 2:B1) {
    ...
    # a1 <- sum(random_points$var1/p)
    
    # Bootstrap iterations
    df_boot <- f_boot(random_points, B2)
    # est_boot_val <- mapply(est_boot, df_boot[, 1], df_boot[, 2])
...
# Estimation of this ratio: 0.1693595
```

```{r}
start.time <- Sys.time()

res_ratio1 <- MC_boot(n, B1 = 1000, B2 = 400, f1 = circle_nb, f2 = circle_vol)
