...
```{r}
tab_ci <- df_total %>%
  kable("latex", booktabs = FALSE, align = "llcccc", caption = paste("Characteristics of confidence intervals when using ", B1, " Monte Carlo iterations and ", B2, " bootstrap replications")) %>% # \\hline
  kable_styling(latex_options = "hold_position") %>%
