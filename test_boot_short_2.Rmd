---
title: "Testing bootstrap processes"
output: pdf_document
date: "2024-08-05"
---
...
Idea for the bootstrap: for each stratum $h$, containing $n_h$ sampled points, $n_h - 1$ points are sampled with replacement. As a result, $100(n_h-1)$ points are sampled from the initial sample. In this case, 900 points are sampled.
