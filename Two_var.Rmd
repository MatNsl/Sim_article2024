...
res1 <- MonteCarlo(n, 10000, circle_nb)
...
res2 <- MC_boot(n, B1 = 1000, B2 = 400, f = circle_nb)
# Just one circle to begin with
...
```{r}
cat("Mean of the variance of bootstrap samples:", res2)
```

# Conclusion

```{r}
cat("We get a difference of: ", 100*(max(res1,res2)-min(res1,res2))/min(res1,res2), "%", sep = "")
```
