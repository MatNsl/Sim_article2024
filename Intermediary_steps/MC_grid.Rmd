...
In this document, \textbf{sampling with a grid} is used to create a sample and \textbf{one single circle} with a radius of 5 is used to compute local variables.
