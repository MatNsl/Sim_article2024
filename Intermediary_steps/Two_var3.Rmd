---
title: "Making sure the variances converge with 3 circles"
output: 
...
res1_nb <- MonteCarlo(n, 10000, circle3_nb)
# 3 circles
...
# Example:
# Monte Carlo variance: 2717279
```

```{r}
start.time <- Sys.time()

res2_nb <- MC_boot(n, B1 = 1000, B2 = 400, f = circle3_nb)
# 3 circles
...
res1_vol <- MonteCarlo(n, 10000, circle3_vol)
# 3 circles
...
# Ex:
# Monte Carlo variance: 84693.99
```

```{r}
start.time <- Sys.time()

res2_vol <- MC_boot(n, B1 = 1000, B2 = 400, f = circle3_vol)
# 3 circles
