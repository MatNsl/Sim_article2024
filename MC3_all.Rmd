...
In this document, \textbf{uniform sampling} is used to create a sample and \textbf{three circles} with radii of 6, 9 and 15 are used to compute local variables.
